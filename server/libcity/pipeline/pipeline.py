...
def run_model(task=None, model_name=None, dataset_name=None, config_file=None,
    ...
    if other_args.get('testonly') == True:
        test_data = dataset.get_data(testonly=True)
    else:
    ...
    if train:
        ...
        # 这里修改模型的文件
        model_cache_file = './libcity/cache/LinearETA_porto_epoch9.tar'
        print('model_cache_file:',model_cache_file)
        # executor.save_model(model_cache_file)
